...
- **Работа с данными:** Pandas, Hadoop, Spark, Kafka, SuperSet, SQL, Postgres, Mongo, ClickHouse
- **Инструменты BI:** VBA, PowerQuery, PowerBI
- **Методологии:** PMBOK, Waterfall, Agile
...
- **Расширенный курс программирования 1С в Нетологии** (в процессе обучения).
